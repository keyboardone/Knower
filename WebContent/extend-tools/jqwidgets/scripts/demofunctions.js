    ...
    if (url.toString().indexOf('mvcexamples') >= 0) {
        ...
        $.get(url,
                        function (data) {
                            ...
                            try {
                                if (widgetName != "php" && widgetName != "twitter" && widgetName != "angularjs" && widgetName != "angularjs-demos" && widgetName != "jquerymobile" && widgetName != "aspnetmvc" && widgetName != "requirejs") {
