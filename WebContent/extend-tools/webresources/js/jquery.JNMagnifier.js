...
(function($){
    $.fn.JNMagnifier=function(setting){
		...
		_img_org_.mousemove(function(e){
			_move_x =0-Math.round((document.documentElement.scrollLeft+e.clientX-__left) * __w - _val_w-10);
			_move_y =0-Math.round((document.documentElement.scrollTop+e.clientY-__top) * __h - _val_h -10);
